...
const features = [
  {
    ...
    description: "Recibe explicaciones adaptadas a tu nivel de conocimiento. Como tener un tutor personal que entiende exactamente cómo aprendes mejor.",
  ...
  {
    icon: MessageSquare,
    title: "Pregunta Sin Límites",
    description: "Haz cualquier pregunta sin miedo al juicio. Conversaciones naturales que te ayudan a entender, no solo a memorizar.",
  ...
  },
  {
    ...
    description: "Aprende más rápido cuando dominas conceptos, toma más tiempo cuando necesitas práctica. Tú tienes el control.",
  ...
  },
  {
    ...
    description: "Comprende las probabilidades reales detrás de juegos y riesgos. Aprende a no dejarte engañar por falsas promesas.",
  ...
  },
  {
    ...
    description: "Obtén información precisa al momento—sin esperas, sin contenido inventado. Solo respuestas verificadas cuando las necesitas.",
  ...
  },
  {
    ...
    description: "Ejercicios personalizados que se enfocan en tus áreas de mejora. No exámenes estresantes—solo práctica que te hace mejor.",
